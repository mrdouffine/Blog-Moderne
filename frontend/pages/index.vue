...
const featuredArticle = computed(() => (articles.value && articles.value[0]) ?? null);
        ...
        >
            ...
            <div class="flex flex-wrap justify-center gap-xs">
                <NuxtLink
                    ...
                    :key="tag.name"
                    :to="`/articles?category=${encodeURIComponent(tag.value)}`"
           ...
           ════════════════════════════════════════════════════ -->
            <section class="mb-xl">
                ...
                >
                    <!-- Image -->
                    <div
                        class="w-full md:w-3/5 aspect-video md:aspect-[16/9] rounded-lg overflow-hidden flex-shrink-0 bg-surface-container-highest"
                    >
                        <img
                            :src="
                ...
                <aside class="lg:col-span-4 flex flex-col gap-md">
                    ...
                    >
                        ...
                        <div class="flex flex-wrap gap-xs">
                            <NuxtLink
                                ...
                                :key="tag"
                                :to="`/articles?category=${encodeURIComponent(tag)}`"
                    ...
                    >
                        ...
                        <div v-else class="flex flex-col gap-md">
                            ...
                            >
                                <div
                                    class="w-16 h-16 flex-shrink-0 rounded-lg overflow-hidden bg-surface-container-highest"
                                >
                                    <img
                                        :src="
                                            article.cover_image ??
