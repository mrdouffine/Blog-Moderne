                ...
                >
                    ...
                    <div class="grid grid-cols-2 gap-sm">
                        ...
                        <button
                            ...
                            class="flex items-center justify-center gap-xs py-3 border border-outline-variant rounded-xl hover:bg-surface transition-colors disabled:opacity-50"
                            @click="loginWithSocial('google')"
                        >
                            <span v-if="socialLoading === 'google'" class="material-symbols-outlined animate-spin text-[20px]">
                                progress_activity
                            </span>
                            <template v-else>
                        ...
                        >
                            <span v-if="socialLoading === 'github'" class="material-symbols-outlined animate-spin text-[20px]">
                                progress_activity
                            </span>
                            <template v-else>
                                <svg
                                ...
                                <span class="font-label-sm text-label-sm text-on-surface">GitHub</span>
                            </template>
                        </button>
                    </div>
